...
- (void)reloadFrame {
    ...
    _cancelButton.frame = _cancelButton.titleLabel.text ? CGRectMake(0,
                                                                     _alertHeight - buttonHeight ,
                                                                     _alertWidth / 2  ,
                                                                     buttonHeight) : CGRectZero;
    
    _confirmButton.frame = _cancelButton.titleLabel.text ?  CGRectMake(_alertWidth / 2  ,
                                                            _alertHeight - buttonHeight  ,
                                                            _alertWidth / 2 ,
